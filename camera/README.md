...
| **`noDevicesText`**       | <code>string</code>                                           | Text value to use when no device is found. The label to explain the error.                                                                                                                                                                                                 | <code>: 'No camera found'</code>    | 4.1.4 |
| **`noDevicesButtonText`** | <code>string</code>                                           | Text value to use when no device is found. The label of the button to select a file.                                                                                                                                                                                       | <code>: 'Choose image'</code>       | 4.1.4 |
| **`showPicImage`**        | <code>boolean</code>                                          | Option to show the gallery button. If false, the user won't be presented with the option to pic a photo from the gallery.                                                                                                                                                  | <code>: true</code>                 | 4.1.4 |
